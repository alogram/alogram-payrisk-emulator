...
class PaymentAuthorizationOutcome(BaseModel):
    ...
    """ # noqa: E501
    approved: Optional[StrictBool] = Field(default=None, description="Indicates whether authorization was approved.")
    response_code: Optional[Annotated[str, Field(strict=True, max_length=16)]] = Field(default=None, description="Authorization response code.", alias="responseCode")
