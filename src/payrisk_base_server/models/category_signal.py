...
class CategorySignal(BaseModel):
    ...
    ] = Field(default=None, description="Category-specific risk score (0.00 - 1.00).")
    reasons: Optional[List[StrictStr]] = Field(
        default=None, description="Specific reason codes for this category."
    )
    metadata: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Derived evidence and enrichment data for this category.",
    )
    __properties: ClassVar[List[str]] = ["level", "score", "reasons", "metadata"]
