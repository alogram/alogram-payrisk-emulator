...
from payrisk_base_server.models.payment_event_type import PaymentEventType
from payrisk_base_server.models.payment_outcome import PaymentOutcome
...
class PaymentEvent(BaseModel):
    ...
    payment_intent_id: Annotated[str, Field(min_length=35, max_length=35)] = Field(
    ...
    timestamp: Annotated[str, Field()] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "outcome": (
                    PaymentOutcome.from_dict(obj.get("outcome"))
