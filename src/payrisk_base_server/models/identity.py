...
from payrisk_base_server.models.postal_address import PostalAddress
...
class Identity(BaseModel):
    ...
    email_domain: Optional[Annotated[str, Field(max_length=255)]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "phone": obj.get("phone"),
                "shippingAddress": (
                    PostalAddress.from_dict(obj.get("shippingAddress"))
                    if obj.get("shippingAddress") is not None
                    else None
                ),
                "billingAddress": (
                    PostalAddress.from_dict(obj.get("billingAddress"))
