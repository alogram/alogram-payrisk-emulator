...
from payrisk_base_server.models.payment_realtime_type_enum import \
...
class Realtime(BaseModel):
    ...
    realtime_type: Optional[PaymentRealtimeTypeEnum] = Field(
        default=None, alias="realtimeType"
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"type": obj.get("type"), "realtimeType": obj.get("realtimeType")}
        )
        return _obj
