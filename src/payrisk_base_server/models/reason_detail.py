...
class ReasonDetail(BaseModel):
    ...
    impact: Optional[StrictStr] = Field(
        default=None,
        description="The structural or mathematical influence of this specific reason on the final decision (e.g., 'critical_trigger', 'suppression_reduction', 'score_increment').",
    )
