...
class SignalsAccountVariant(BaseModel):
    """
    Account-level signal variant (single account state snapshot).
    """ # noqa: E501
    signal_type: StrictStr = Field(description="Value for account signals.", alias="signalType")
    entities: EntityIds
    account: Account
    __properties: ClassVar[List[str]] = ["signalType", "entities", "account"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SignalsAccountVariant from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SignalsAccountVariant from a dict"""
        if obj is None:
            return None
