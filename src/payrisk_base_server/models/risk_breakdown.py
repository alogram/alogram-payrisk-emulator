...
class RiskBreakdown(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "geography": (
                    CategorySignal.from_dict(obj.get("geography"))
                    if obj.get("geography") is not None
                    else None
                ),
                "identity": (
                    CategorySignal.from_dict(obj.get("identity"))
                    if obj.get("identity") is not None
                    else None
                ),
                "behavior": (
                    CategorySignal.from_dict(obj.get("behavior"))
                    if obj.get("behavior") is not None
                    else None
                ),
                "transaction": (
                    CategorySignal.from_dict(obj.get("transaction"))
                    if obj.get("transaction") is not None
                    else None
                ),
                "network": (
                    CategorySignal.from_dict(obj.get("network"))
