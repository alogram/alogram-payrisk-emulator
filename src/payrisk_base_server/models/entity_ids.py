...
class EntityIds(BaseModel):
    ...
    tenant_id: Optional[Annotated[str, Field(min_length=5, max_length=64)]] = Field(
        default=None,
    ...
    client_id: Optional[Annotated[str, Field(min_length=5, max_length=100)]] = Field(
        default=None,
    ...
    member_id: Optional[Annotated[str, Field(min_length=5, max_length=100)]] = Field(
        default=None,
    ...
    def tenant_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^tid_[a-z0-9\-_]{2,60}$", value):
            raise ValueError(
                r"must validate the regular expression /^tid_[a-z0-9\-_]{2,60}$/"
            )
        return value
    ...
    def client_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^cid_[a-z0-9\-_]{2,96}$", value):
            raise ValueError(
                r"must validate the regular expression /^cid_[a-z0-9\-_]{2,96}$/"
            )
        return value
    ...
    def end_customer_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^ecid_[a-z0-9\-_]{2,96}$", value):
            raise ValueError(
                r"must validate the regular expression /^ecid_[a-z0-9\-_]{2,96}$/"
            )
        return value
    ...
    def member_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^mid_[a-z0-9\-_]{2,96}$", value):
            raise ValueError(
                r"must validate the regular expression /^mid_[a-z0-9\-_]{2,96}$/"
            )
        return value
