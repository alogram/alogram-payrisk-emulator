...
class DecisionResponse(BaseModel):
    ...
    assessment_id: Annotated[str, Field(min_length=8, max_length=64)] = Field(
    ...
    ttl_seconds: Optional[Annotated[int, Field(ge=0)]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "fraudScore": (
                    FraudScore.from_dict(obj.get("fraudScore"))
