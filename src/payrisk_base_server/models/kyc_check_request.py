...
from payrisk_base_server.models.kyc_payload import KycPayload
try:
...
class KycCheckRequest(BaseModel):
    ...
    KycCheckRequest
    """ # noqa: E501
    event_subtype: StrictStr = Field(description="The specific subtype of the KYC event.", alias="eventSubtype")
    ...
    def event_subtype_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('pre_kyc_check', 'doc_scan', 'liveness', 'address_check', 'sanctions_pep',):
            raise ValueError("must be one of enum values ('pre_kyc_check', 'doc_scan', 'liveness', 'address_check', 'sanctions_pep')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "kyc": KycPayload.from_dict(obj.get("kyc")) if obj.get("kyc") is not None else None
        })
        return _obj
