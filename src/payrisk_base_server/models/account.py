...
class Account(BaseModel):
    ...
    phone: Optional[Annotated[str, Field(min_length=7, max_length=30)]] = Field(
        default=None,
    ...
    email: Optional[Annotated[str, Field(min_length=3, max_length=320)]] = Field(
        default=None, description="Email address of the customer."
    )
