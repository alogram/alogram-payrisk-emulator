...
class MerchantContext(BaseModel):
    ...
    """ # noqa: E501
    mcc: Optional[Annotated[str, Field(min_length=4, strict=True, max_length=4)]] = Field(default=None, description="Merchant Category Code (MCC) for the merchant.")
    merchant_country: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=2)]] = Field(default=None, description="ISO 3166-1 alpha-2 country code.", alias="merchantCountry")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "mcc": obj.get("mcc"),
            "merchantCountry": obj.get("merchantCountry")
        })
        return _obj
