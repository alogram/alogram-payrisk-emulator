...
from payrisk_base_server.models.payment_card_type_enum import \
    PaymentCardTypeEnum
...
class Card(BaseModel):
    ...
    bin: Optional[Annotated[str, Field(min_length=6, max_length=8)]] = Field(
        default=None,
        description="Bank Identification Number (IIN). First 6-8 digits of the PAN; do not send full PAN.",
    )
    issuer_country: Optional[Annotated[str, Field(min_length=2, max_length=64)]] = (
        Field(
            default=None,
            description="ISO 3166-1 alpha-2 country code or full country name.",
            alias="issuerCountry",
        )
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "threeDS": (
                    ThreeDSData.from_dict(obj.get("threeDS"))
