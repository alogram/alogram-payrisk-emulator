...
class Problem(BaseModel):
    ...
    title: Optional[Annotated[str, Field(min_length=3, max_length=100)]] = Field(
        default=None, description="A short, human-readable summary of the problem type."
    )
    status: Optional[Annotated[int, Field(le=599, ge=100)]] = Field(
        default=None, description="The HTTP status code applicable to this problem."
    )
    detail: Optional[Annotated[str, Field(min_length=3, max_length=1024)]] = Field(
        default=None,
        description="Human-readable explanation specific to this occurrence.",
    )
    instance: Optional[Annotated[str, Field(min_length=1, max_length=1024)]] = Field(
        default=None,
        description="A URI reference that identifies the specific occurrence.",
    )
    error_code: Optional[Annotated[str, Field(min_length=3, max_length=50)]] = Field(
        default=None, description="Application-specific error code.", alias="errorCode"
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "type": (
                    obj.get("type") if obj.get("type") is not None else "about:blank"
                ),
                "title": obj.get("title"),
