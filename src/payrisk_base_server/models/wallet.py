...
from payrisk_base_server.models.payment_wallet_type_enum import PaymentWalletTypeEnum
try:
...
class Wallet(BaseModel):
    ...
    wallet_type: Optional[PaymentWalletTypeEnum] = Field(default=None, alias="walletType")
