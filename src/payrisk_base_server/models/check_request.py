...
from payrisk_base_server.models.external_assessment import ExternalAssessment
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.external_assessments:
            for _item in self.external_assessments:
                if _item:
        ...
        _obj = cls.model_validate(
            {
                ...
                "purchase": (
                    Purchase.from_dict(obj.get("purchase"))
                    if obj.get("purchase") is not None
                    else None
                ),
                "identity": (
                    Identity.from_dict(obj.get("identity"))
                ...
                "externalAssessments": (
                    [
                        ...
                        for _item in obj.get("externalAssessments")
                    ]
