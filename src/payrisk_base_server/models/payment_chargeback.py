...
class PaymentChargeback(BaseModel):
    """
    Chargeback details, including reason code.
    """ # noqa: E501
    reason: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="Chargeback reason code.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentChargeback from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentChargeback from a dict"""
        if obj is None:
            return None
